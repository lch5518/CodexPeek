...
fn every_required_localization_key_has_nonempty_korean_and_english_text() {
    let required_keys = [
        ...
        LocalizationKey::MenuDisplayMode,
        LocalizationKey::MenuTaskbarMode,
        LocalizationKey::MenuFloatingMode,
        ...
        LocalizationKey::MenuAlwaysOnTop,
        LocalizationKey::MenuLanguage,
        LocalizationKey::MenuPositionReset,
